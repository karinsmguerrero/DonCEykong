...
int move_balloon(GtkWidget *data)
{
    ...
    if(y_cord>650)
    {
        ...
        balloon_wid=xpm_create(window, "/home/karina/CLionProjects/untitled/balloon.png");
...
int move_arrow(GtkWidget *data)
{
    ...
    {
        gtk_widget_destroy(balloon_wid);
        balloon_wid=xpm_create(window, "/home/karina/CLionProjects/untitled/burst.png");
        gtk_widget_show(balloon_wid);
        gtk_fixed_put (GTK_FIXED (fixed), balloon_wid , 1100, y_cord);
        score++;
        //g_print("Score : %d \n",score);
          ...
          char *argv[] )
{
    ...
    bckgrnd_wid= xpm_create(window, "/home/karina/CLionProjects/untitled/imgs/level_1_bg.png");
    ...
    archr_wid= xpm_create(window, "/home/karina/CLionProjects/untitled/archer.png");
    gtk_widget_show(archr_wid);
    gtk_fixed_put (GTK_FIXED (fixed), archr_wid, 50, 550);
    arrow_wid= xpm_create(window, "/home/karina/CLionProjects/untitled/arrow.png");
